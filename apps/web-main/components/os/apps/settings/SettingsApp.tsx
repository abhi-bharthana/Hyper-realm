...
import { User, LayoutDashboard, Palette, Activity, Shield } from 'lucide-react'; // 🚀 Shield import kiya
...
import PrivacyModule from './modules/PrivacyModule'; // 🚀 Naya module import kiya
  ...
  return (
    <div className="flex h-full w-full text-white overflow-hidden bg-transparent font-sans">
      ...
      <div className="flex-1 overflow-y-auto p-10 pb-24 relative bg-gradient-to-br from-black/10 to-transparent custom-scrollbar">
        ...
        {activeTab === 'privacy' && <PrivacyModule />} {/* 🚀 MODULE RENDER */}
